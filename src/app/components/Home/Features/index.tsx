    ...
    <section id='features'>
      <div className='container'>
        ...
        <p className='text-black/60 text-lg text-center md:max-w-[60%] mx-auto'>
          We craft custom software solutions that power your business forward. From idea to deployment, our expert team delivers secure, scalable, and future-ready applications tailored to your needs.
        </p>

...
import logo from '../../../../../public/images/logo/comlogo.png'
    ...
    <header
      ...
      <div>
        <div className='container flex items-center justify-between'>
          <div>
            <Image src={logo} alt='Company Logo' width={110} height={20} /> 
          </div>
          <nav className='hidden lg:flex grow items-center gap-20 justify-center md:ml-20'>
          ...
          <div className='flex items-center gap-4'>
            ...
            <button
             ...
             <span className={`block w-6 h-0.5 ${sticky ? 'bg-black' : 'bg-white'}`}></span>
              ...
              <span className={`block w-6 h-0.5 ${sticky ? 'bg-black' : 'bg-white'} mt-1.5`}></span>
              <span className={`block w-6 h-0.5 ${sticky ? 'bg-black' : 'bg-white'} mt-1.5`}></span>
            </button>
          </div>
        </div>
